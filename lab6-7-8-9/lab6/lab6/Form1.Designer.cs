namespace lab6
{
    partial class Form1
    {
		...
		private void InitializeComponent()
		{
			...
			buttonRefl.Location = new Point(3, 393);
			...
			comboBoxShading.Location = new Point(3, 442);
			comboBoxShading.Margin = new Padding(3, 2, 3, 2);
			comboBoxShading.Name = "comboBoxShading";
			comboBoxShading.Size = new Size(155, 23);
			comboBoxShading.TabIndex = 19;
			comboBoxShading.SelectedIndexChanged += comboBoxShading_SelectedIndexChanged;
			// 
			// buttonTexture
			// 
			buttonTexture.Location = new Point(4, 513);
			buttonTexture.Margin = new Padding(3, 2, 3, 2);
			buttonTexture.Name = "buttonTexture";
			buttonTexture.Size = new Size(150, 22);
			...
			buttonLighting.Location = new Point(4, 482);
			...
			comboBoxReflection.Location = new Point(4, 369);
			...
			label8.Location = new Point(1, 344);
			label8.Name = "label8";
			...
			tableLayoutPanel1.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 20F));
			tableLayoutPanel1.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 20F));
			tableLayoutPanel1.Controls.Add(buttonSecondPoly, 4, 1);
			...
			// buttonSecondPoly
			// 
			buttonSecondPoly.Font = new Font("Segoe UI", 12F);
			buttonSecondPoly.Location = new Point(636, 35);
			buttonSecondPoly.Margin = new Padding(4, 3, 4, 3);
			buttonSecondPoly.Name = "buttonSecondPoly";
			buttonSecondPoly.Size = new Size(148, 28);
			buttonSecondPoly.TabIndex = 15;
			buttonSecondPoly.Text = "Вторая фигура";
			buttonSecondPoly.TextAlign = ContentAlignment.TopCenter;
			buttonSecondPoly.UseVisualStyleBackColor = true;
			buttonSecondPoly.Click += buttonSecondPoly_Click;
			// 
			// Form1
			// 
		...
		private Button buttonSecondPoly;
	}
}